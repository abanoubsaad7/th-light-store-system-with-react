...
const AddNewMaterial = () => {
  const handleAddingMaterial = (event)=>{
    ...
    axios.post('https://th-light-store-system.onrender.com/matrials/add-new-material',formData , config)
      .then((res)=>{
        alert(res.data.msg);
      })
  ...
  return (
    <form method='post' onSubmit={handleAddingMaterial}>
      ...
      <input type="number" name="numberOfMatrials"  placeholder="numberOfMatrials"/>
      <br /><br />
      <label>price</label>
